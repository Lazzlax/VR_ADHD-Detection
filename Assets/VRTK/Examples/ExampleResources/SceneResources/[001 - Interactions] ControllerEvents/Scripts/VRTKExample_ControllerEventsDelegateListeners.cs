namespace VRTK.Examples
{
    ...
    public class VRTKExample_ControllerEventsDelegateListeners : MonoBehaviour
    {
        ...
        public Instruction audioControl;
        ...
        {
            if (buttonTwoButtonEvents && audioControl.completeAudio == true)
            {
                audioControl.menuInstruction.SetActive(true);
                audioControl.playerViewObj.SetActive(false);
            }
        }
